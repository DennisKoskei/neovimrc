--[[ This is my Customized Configuration file ]]
...
require("lazy").setup({
	...
	{ -- Luarocks Package Manager NOTE: Look for a way to disable this plugin
	...
	{ -- Autoformat
		...
		opts = {
			...
			formatters_by_ft = {
				lua = { "stylua" },
				python = { "black" }, -- Conform can also run multiple formatters sequentially
			},
		},
	},
